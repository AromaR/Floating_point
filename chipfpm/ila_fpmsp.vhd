...
-- /___/   /\     Timestamp: Sat Apr 04 14:49:02 2015
-- \   \  /  \ 
--  \___\/\___\
--             
-- Command	: -w -sim -ofmt vhdl "C:/Documents and Settings/Administrator/Desktop/134143 projectfiles/chipfpm/tmp/_cg/ila_fpmsp.ngc" "C:/Documents and Settings/Administrator/Desktop/134143 projectfiles/chipfpm/tmp/_cg/ila_fpmsp.vhd" 
...
-- Output file	: C:/Documents and Settings/Administrator/Desktop/134143 projectfiles/chipfpm/tmp/_cg/ila_fpmsp.vhd
-- # of Entities	: 1
...
architecture STRUCTURE of ila_fpmsp is
  signal N0 : STD_LOGIC; 
  signal N1 : STD_LOGIC; 
  ...
  signal U0_I_YES_D_U_ILA_I_DQ_U_DQQ_temp : STD_LOGIC_VECTOR ( 147 downto 0 ); 
  ...
  signal U0_I_YES_D_U_ILA_iDATA : STD_LOGIC_VECTOR ( 147 downto 0 ); 
  signal U0_I_YES_D_U_ILA_iRESET : STD_LOGIC_VECTOR ( 7 downto 0 ); 
  signal U0_iDATA : STD_LOGIC_VECTOR ( 147 downto 0 ); 
begin
  XST_GND : GND
    port map (
      G => N0
...
NLW_U0_I_YES_D_U_ILA_U_TRIG_U_TC_I_STORAGE_QUAL_U_STORAGE_QUAL_I_SRLT_NE_1_I_NMU_1_TO_4_U_TCL_I_NMU_EQ1_U_iDOUT_I_NOLUT6_I_SRL_T2_U_SRLC16E_Q15_UNCONNECTED
  ...
  U0_I_YES_D_U_ILA_U_CAPSTOR_I_CASE1_I_NO_TB_I_RT1_U_RAM_G_BRAM_0_U_BRAM_ram_rt1_s1_s32_if_ram_rt1_s1_s32_i : RAMB16_S1_S36
    ...
    port map (
      ...
      DIB(31) => N0,
      DIB(30) => N0,
      DIB(29) => U0_I_YES_D_U_ILA_iDATA(144),
      DIB(28) => U0_I_YES_D_U_ILA_iDATA(139),
      DIB(27) => U0_I_YES_D_U_ILA_iDATA(134),
      DIB(26) => U0_I_YES_D_U_ILA_iDATA(129),
  ...
  U0_I_YES_D_U_ILA_U_CAPSTOR_I_CASE1_I_NO_TB_I_RT1_U_RAM_G_BRAM_1_U_BRAM_ram_rt1_s1_s32_if_ram_rt1_s1_s32_i : RAMB16_S1_S36
    ...
    port map (
      ...
      DIB(31) => N0,
      DIB(30) => N0,
      DIB(29) => U0_I_YES_D_U_ILA_iDATA(145),
      DIB(28) => U0_I_YES_D_U_ILA_iDATA(140),
      DIB(27) => U0_I_YES_D_U_ILA_iDATA(135),
      DIB(26) => U0_I_YES_D_U_ILA_iDATA(130),
  ...
  U0_I_YES_D_U_ILA_U_CAPSTOR_I_CASE1_I_NO_TB_I_RT1_U_RAM_G_BRAM_2_U_BRAM_ram_rt1_s1_s32_if_ram_rt1_s1_s32_i : RAMB16_S1_S36
    ...
    port map (
      ...
      DIB(31) => N0,
      DIB(30) => N0,
      DIB(29) => U0_I_YES_D_U_ILA_iDATA(146),
      DIB(28) => U0_I_YES_D_U_ILA_iDATA(141),
      DIB(27) => U0_I_YES_D_U_ILA_iDATA(136),
      DIB(26) => U0_I_YES_D_U_ILA_iDATA(131),
  ...
  U0_I_YES_D_U_ILA_U_CAPSTOR_I_CASE1_I_NO_TB_I_RT1_U_RAM_G_BRAM_3_U_BRAM_ram_rt1_s1_s32_if_ram_rt1_s1_s32_i : RAMB16_S1_S36
    ...
    port map (
      ...
      DIB(31) => N0,
      DIB(30) => N0,
      DIB(29) => U0_I_YES_D_U_ILA_iDATA(147),
      DIB(28) => U0_I_YES_D_U_ILA_iDATA(142),
      DIB(27) => U0_I_YES_D_U_ILA_iDATA(137),
      DIB(26) => U0_I_YES_D_U_ILA_iDATA(132),
  ...
  U0_I_YES_D_U_ILA_U_CAPSTOR_I_CASE1_I_NO_TB_I_RT1_U_RAM_G_BRAM_4_U_BRAM_ram_rt1_s1_s32_if_ram_rt1_s1_s32_i : RAMB16_S1_S36
    ...
    port map (
      ...
      DIB(30) => N0,
      DIB(29) => N0,
      DIB(28) => U0_I_YES_D_U_ILA_iDATA(143),
      DIB(27) => U0_I_YES_D_U_ILA_iDATA(138),
      DIB(26) => U0_I_YES_D_U_ILA_iDATA(133),
      DIB(25) => U0_I_YES_D_U_ILA_iDATA(128),
